...
intmax_t *k, *l;
struct timeval t1, t2, t1_write, t2_write, t2_load;
float t_gpu=0, t_total=0, t_write=0, t_load=0;
...
int main(int argc, char **argv) {
	...
	t_load = (t2_load.tv_sec-t1.tv_sec)*1e6+(t2_load.tv_usec-t1.tv_usec);
